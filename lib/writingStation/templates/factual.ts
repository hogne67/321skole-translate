  ...
  rooms: [
    {
      ...
      sections: [
        ...
        },
        {
          id: "sources",
          title: "Kilder",
          prompt: "Hvor kan du finne informasjon?",
          supportWords: ["kilde", "nettsted", "bok", "jeg fant", "jeg må sjekke", "pålitelige kilder"],
          fields: [
            { id: "sources_list", label: "Foreløpige kilder", kind: "long_text", placeholder: "Skriv hvor du kan finne fakta." },
            { id: "sources_check", label: "Hva må sjekkes?", kind: "long_text", placeholder: "Hva er du usikker på, eller må sjekke før teksten er ferdig?" },
          ],
          aiPolicy: planningAiPolicy,
        },
      ],
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          fields: [
            { id: "source_web_url", label: "Nettlenke", kind: "short_text", placeholder: "Lim inn lenke til nettsiden." },
            { id: "source_web_title", label: "Navn på nettside eller artikkel", kind: "short_text", placeholder: "For eksempel: Store norske leksikon - Kong Harald V" },
            { id: "source_book_title", label: "Tittel på bok", kind: "short_text" },
            { id: "source_author", label: "Forfatter", kind: "short_text" },
            { id: "sources_list", label: "Andre kilder eller notater", kind: "long_text", placeholder: "Skriv andre kilder, bilder eller hvor fakta er hentet fra." },
            { id: "sources_check", label: "Kildekritikk", kind: "long_text", placeholder: "Hvorfor passer kildene? Hva må du være litt forsiktig med?" },
          ],
