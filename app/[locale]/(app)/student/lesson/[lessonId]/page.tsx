      ...
      try {
        ...
        try {
          ...
          if (publishedSnap.exists()) {
            ...
            loadedLesson = {
              ...
              text: rawData.text,
              highFrequencyWord: rawData.highFrequencyWord,
              highFrequencyReadingSentences: rawData.highFrequencyReadingSentences,
              highFrequencyExplanation: rawData.highFrequencyExplanation,
              status: "published",
        ...
        if (!loadedLesson) {
          ...
          loadedLesson = {
            ...
            highFrequencyWord: rawPrivate.highFrequencyWord,
            highFrequencyReadingSentences: rawPrivate.highFrequencyReadingSentences,
            highFrequencyExplanation: rawPrivate.highFrequencyExplanation,
