...
import {
  englishSoundWordContainsSound,
  englishSoundWordStartsWithSound,
  getEnglishInsideSoundWords,
  getEnglishSoundBank,
  getEnglishSoundWords,
...
function buildA1StartSoundLadderPrompt(languageName: string, config: A1StartConfig): string {
  ...
  const englishSoundBank =
    languageName === "English" ? getEnglishSoundBank(focusSound) : null;
  ...
  const norwegianSoundBankWords = norwegianSoundBank
    ...
    : "";
  const englishSoundBankWords = englishSoundBank
    ? englishSoundBank.words.map((item) => item.word).join(", ")
    : "";
...
`.trim()
    : "";
  const englishSoundBankGuidance = englishSoundBank
    ? `
English sound bank:
- Use these approved A1-friendly words for "${focusSound}" when possible: ${englishSoundBankWords}
- The word bank is the source of truth for vulnerable English sounds and spellings.
- For "g", use hard g words such as go/game and avoid soft g words such as giant, gym and giraffe.
- For "h", use pronounced h words and avoid silent h words such as hour and honest.
- For "w", use pronounced w words. For "y", use consonant y words such as yes/you, not vowel-y words.
- For "ch", use ch as in chair/chip and avoid ch words with /k/ or /sh/ such as school, Christmas and chef.
- For "hard c / k", use hard c words such as cat/cup/cake and avoid soft c words such as city and pencil.
- For "soft c / s", use soft c words such as city/circle/pencil and avoid hard c words such as cat and cup.
- For "qu", use common qu words with the /kw/ sound.
- For "ck", use common ck words. It is normal that ck comes later in the word.
- For short vowel choices, keep the vowel quality stable: "short a / cat", "short e / bed", "short i / sit", "short o / dog" and "short u / sun". Avoid long-vowel distractors such as cake/name, me/see, bike/time, go/home and cute/use.
- For long vowel choices, keep the vowel quality stable: "long a / cake", "long e / see", "long i / bike", "long o / home" and "long u / cute". Avoid short-vowel distractors such as cat/bed/sit/dog/sun.
- For vowel spelling choices, keep the selected pattern stable: "oo / moon" uses long oo as in moon/food, "oo / book" uses short oo as in book/look/good, "ea / bread" uses ea with short e as in bread/head, "er / bird" uses r-controlled er/ir/ur/or as in bird/her/work, "or / fork" uses or as in fork/short/morning, and "ar / car" uses ar as in car/park/farm.
- For "oo / book", avoid long-oo distractors such as moon, food, school, pool, soon and zoo in the word list, sound sentences and coherent text. For "oo / moon", avoid short-oo distractors such as book, look and good in the word list, sound sentences and coherent text.
- For "ea / bread", avoid long-e words with ea such as eat, read and teacher in the word list and sound sentences.
- For spelling-pattern choices such as "ai / rain", "ay / day", "ee / tree", "oa / boat", "ow / snow" and "igh / night", prefer words from that exact spelling pattern. For "ow / snow", avoid /ou/ words such as cow, how and now.
- For "oi / coin" and "oy / boy", keep the spelling pattern separate when possible. For "oy / boy", avoid adding unusual extra words such as soy unless the teacher selected them.
- For "ou / house", avoid long-oo ou words such as soup/group. For "ow / cow", avoid long-o ow words such as snow/window/yellow.
- For "air / chair" and "are / care", use the air sound. For "ear / hear", use the hear sound and avoid air-sound words such as bear, pear, wear, care, share and square.
- Do not add random theme words to the word and sentence sections unless they practise the focus sound.
`.trim()
    : "";
...
- For vowels, keep the selected vowel quality stable. For "e aberto / é" use open e words; for "e fechado / ê" use closed e words; for "o aberto / ó" use open o words; for "o fechado / ô" use closed o words. For nasal vowel choices, use words from the selected nasal bank and do not mix with the oral vowel bank.
- For "e aberto / é", avoid closed-e distractors such as "bebê" when possible, especially in the story.
- Do not add random theme words to the word and sentence sections unless they practise the focus sound.
...
`.trim()
    : "";
  const soundBankGuidance = [norwegianSoundBankGuidance, englishSoundBankGuidance, portugueseSoundBankGuidance]
    .filter(Boolean)
    .join("\n\n");
...
- HARD RULE: Every word in "${labels.wordTraining}" must practise the focus sound "${focusSound}". ${norwegianSoundBank || englishSoundBank || portugueseSoundBank ? "Use the approved word bank above as the main check." : `A word without "${focusSound}" is invalid.`}
...
- Before returning, check every word silently. ${norwegianSoundBank || englishSoundBank || portugueseSoundBank ? "Remove and replace any word that does not practise the selected sound according to the approved word bank." : `Remove and replace any word that does not contain "${focusSound}".`}
...
function getSoundTrainingWords(languageName: string, focusSound: string, count: number): string[] {
  ...
  if (languageName === "English") {
    const source = getEnglishSoundWords(key, count);
    if (source.length) {
...
function getSoundTrainingSentences(languageName: string, focusSound: string, count: number): string[] {
  ...
  const en: Record<string, string[]> = {
    ...
    "long e / see": [
      ...
      "I see a green tree.",
      "Three children sleep.",
      "The teacher is at the beach.",
      "The team has clean feet.",
      "Please sit with me.",
      "She helps me read.",
    ],
    "long i / bike": [
      ...
      "The ice is cold.",
      "I have an idea.",
      "The island is in the book.",
      "It is time to ride.",
      "I have five kites.",
      "The white line is long.",
      "I like rice.",
      "The child has a nice smile.",
      "I find my bike at night.",
    ],
    "long o / home": [
      "We go home.",
      "The old door is open.",
      "The bird flies over the road.",
      "Only Tom has a phone.",
      "No one is at home.",
      "My nose is cold.",
      "The stone is by the boat.",
      "The coat is yellow.",
      "Snow is on the window.",
      "We show the slow car.",
    ],
    "long u / cute": [
      "I use a computer.",
      "The unit is small.",
      "The uniform is blue.",
      "I usually hear music.",
      "The cute cat sleeps.",
      "The student reads in June.",
      "The cube is blue.",
      "The tube is on the table.",
      "The menu is simple.",
      "The room is huge.",
    ],
    "oo / moon": [
    ...
    "er / bird": [
      "Her bird sings.",
      "The bird is small.",
      "The girl reads first.",
      "The shirt is purple.",
      "The skirt is red.",
      "It is your turn.",
      "The nurse helps us.",
      "The circle is purple.",
      "I read the word.",
      "I work at school.",
    ],
    "or / fork": [
    ...
    "ear / hear": [
      ...
      "The deer is in the book.",
    ],
    "are / care": [
      "I care for my dog.",
      "We share the food.",
      "The square is red.",
      "The story can scare me.",
      "The table is bare.",
      "The rare bird is blue.",
      "I dare to try.",
      "We prepare lunch.",
    ],
    s: [
  ...
  const pt: Record<string, string[]> = {
    ...
    "a nasal / ã/an/am": [
      ...
      "A maçã está na mesa.",
      "Eu estudo de manhã.",
      "Minha irmã lê um livro.",
      "A criança canta.",
      "A dança é bonita.",
      "Ana canta na sala.",
      "O menino anda devagar.",
      "A banana está no prato.",
    ],
    "e nasal / en/em": [
      "Eu tenho um livro.",
      ...
      "O vento está forte.",
      "O menino sente frio.",
      "A entrada fica perto.",
    ],
    "i nasal / in/im": [
      "Sim, eu vou.",
      "O fim da aula chegou.",
      "Isto é para mim.",
      "Eu tenho cinco lápis.",
      "O chão está limpo.",
      "O dia está lindo.",
      "A tinta é azul.",
      "Eu gosto de pintar.",
    ...
    "o nasal / on/om": [
      ...
      "Eu vou com Ana.",
      "Onde está o livro?",
      "Ontem eu li um texto.",
      "Eu tenho onze livros.",
      "A conta está certa.",
      "Eu vou contar uma história.",
      "O ponto está no mapa.",
      "A sombra é grande.",
    ],
    "u nasal / um/un": [
      "Um aluno lê.",
    ...
    "e fechado / ê": [
      ...
      "O bebê dorme.",
      "O lápis é preto.",
      "O peixe está no prato.",
      "A mãe dá um beijo.",
      "Eu como queijo.",
      "Eu tenho seis livros.",
      "Eu tenho três lápis.",
      "A meia é azul.",
      "Eu tomo leite.",
      "A folha é verde.",
    ...
    t: [
      "O tatu está no livro.",
      "O teto é branco.",
      "O tomate está no prato.",
      "Tudo está pronto.",
      "Todos estão na sala.",
      "O trem chega cedo.",
    ...
    z: [
      "O número é zero.",
      "A zebra está no livro.",
      "O zíper está aberto.",
      "Zeca está na escola.",
      "O menino está zangado.",
      "O zoológico fica longe.",
      "A casa é bonita.",
      "A mesa está limpa.",
      "A rosa é bonita.",
      "A camisa é azul.",
    ...
    c: [
      ...
      "O café está na mesa.",
      "O caderno está na mochila.",
      "A cadeira está na sala.",
      "A camisa é azul.",
      "A carne está no prato.",
      "A cor é bonita.",
    ],
    l: [
      "Lia vê a lua.",
...
function isEnglishWordCompatibleWithFocusSound(word: string, focusSound: string, languageName: string): boolean {
  if (languageName !== "English") return true;

  const normalizedWord = word.toLocaleLowerCase();
  const normalizedSound = focusSound.toLocaleLowerCase();
  const soundBank = getEnglishSoundBank(normalizedSound);
  if (soundBank?.risk === "sensitive") {
    return isApprovedEnglishSoundWord(normalizedSound, normalizedWord);
  }
...
function startsWithFocusSound(word: string, focusSound: string, languageName: string): boolean {
  ...
  if (languageName === "English" && getEnglishSoundBank(focusSound)) {
    return (
      isEnglishWordCompatibleWithFocusSound(word, focusSound, languageName) &&
      englishSoundWordStartsWithSound(focusSound, word)
    );
  }
...
function containsFocusSound(word: string, focusSound: string, languageName: string): boolean {
  ...
  if (languageName === "English" && getEnglishSoundBank(focusSound)) {
    return (
      isEnglishWordCompatibleWithFocusSound(word, focusSound, languageName) &&
      englishSoundWordContainsSound(focusSound, word)
    );
  }
  if (languageName === "Brazilian Portuguese" && getPortugueseSoundBank(focusSound)) {
    return (
...
function getInsideSoundFallbackWords(languageName: string, focusSound: string): string[] {
  ...
  if (languageName === "English") {
    const source = getEnglishInsideSoundWords(key);
...
function simpleSoundSentence(languageName: string, word: string): string {
  ...
  if (languageName === "English") {
    const englishSpecificPhrases: Record<string, string> = {
      apple: "I eat an apple.",
      ant: "The ant is small.",
      and: "Sam and Anna play.",
      at: "I am at school.",
      am: "I am happy.",
      ask: "Anna asks Dad.",
      age: "Amy tells her age.",
      april: "April is a nice month.",
      amy: "Amy ate cake.",
      ate: "I ate cake.",
      animal: "The animal is sad.",
      ...
      egg: "Emma eats an egg.",
      end: "The end is here.",
      emma: "Emma reads a book.",
      every: "We read every day.",
      each: "Each child can read.",
      easy: "The game is easy.",
      evening: "We read in the evening.",
      me: "Mom reads to me.",
      pet: "My pet is small.",
      red: "The red pen is on the bed.",
      bed: "The bed is soft.",
      sister: "My sister is kind.",
      enjoy: "I enjoy the game.",
      friend: "I play with a friend.",
      help: "I help my mom.",
      send: "I send a card.",
      best: "He is my best friend.",
      meet: "We meet at school.",
      get: "I get a red pen.",
      net: "The net is red.",
      sun: "I see the sun.",
      ...
      is: "The fish is big.",
      it: "It is in the bag.",
      if: "If it rains, we stay in.",
      ill: "The child is ill.",
      inside: "The toy is inside.",
      sit: "I sit in the sun.",
      see: "I see three bees.",
      sock: "The sock is red.",
      soup: "The soup is hot.",
      sad: "The child is sad.",
      sing: "My sister sings a song.",
      school: "Sam sits at school.",
      small: "The mouse is small.",
      six: "I have six socks.",
      miss: "I miss my friend.",
      soon: "We go soon.",
      story: "The story is simple.",
      sleep: "We sleep at night.",
      eat: "I eat cheese.",
      team: "The team reads together.",
      feet: "My feet are clean.",
      bus: "The bus is big.",
      house: "Our house is small.",
      pencil: "The pencil is blue.",
      dress: "The dress is red.",
      yes: "Yes, I can read.",
      horse: "The horse is big.",
      mom: "Mom makes milk.",
      pond: "The duck is in the pond.",
      man: "I meet a man.",
      milk: "I drink milk.",
      map: "My map is on the mat.",
      moon: "I see the moon.",
      noon: "We eat at noon.",
      my: "My bag is blue.",
      make: "I make a card.",
      more: "I want more water.",
      morning: "My morning is calm.",
      mouse: "The mouse is small.",
      music: "I hear music.",
      meal: "Mom makes a meal.",
      one: "I have one book.",
      home: "I go home.",
      family: "My family has fun.",
      summer: "Summer is warm.",
      swim: "We swim in summer.",
      room: "The room is clean.",
      game: "The game is fun.",
      name: "My name is Amy.",
      cool: "School is cool.",
      pool: "The pool is blue.",
      spoon: "The spoon is on the table.",
      too: "I want food too.",
      boot: "The boot is black.",
      cook: "I cook with Mom.",
      hood: "The hood is red.",
      hook: "The hook is small.",
      took: "She took a book.",
      stood: "He stood by the door.",
      heavy: "The bag is heavy.",
      healthy: "The food is healthy.",
      ready: "Breakfast is ready.",
      weather: "The weather is wet.",
      sweater: "My sweater is red.",
      feather: "The feather is soft.",
      treasure: "The treasure is in the box.",
      train: "The train is late.",
      same: "We take the same road.",
      late: "The train is late.",
      come: "Come with me.",
      lemon: "I like lemon.",
      fish: "The fish is small.",
      fun: "My family has fun.",
      fan: "The fan is on.",
      food: "The food is hot.",
      foot: "My foot is cold.",
      five: "I have five kites.",
      face: "Her face is fine.",
      farm: "The frog is on the farm.",
      fast: "We run fast.",
      fine: "I am fine.",
      frog: "The frog is green.",
      fruit: "I eat fruit.",
      floor: "The fan is on the floor.",
      off: "The light is off.",
      leaf: "The leaf is green.",
      soft: "The bed is soft.",
      after: "We play after school.",
      breakfast: "Breakfast is ready.",
      fluffy: "The cat is fluffy.",
      cheerful: "She is cheerful.",
      friendly: "He is friendly.",
      big: "The dog is big.",
      bag: "My bag is blue.",
      ball: "We play with the ball.",
      book: "I read a book.",
      boy: "The boy has a toy.",
      baby: "The baby has a ball.",
      blue: "The box is blue.",
      bird: "The bird sings.",
      box: "The box is on the table.",
      bread: "The bread is fresh.",
      bike: "The bike is red.",
      bath: "The boy has a bath.",
      ben: "Ben sees a bird.",
      table: "The table is big.",
      rabbit: "The rabbit is small.",
      cabin: "The cabin is small.",
      job: "Dad has a job.",
      tub: "The tub is clean.",
      dad: "Dad sees a dog.",
      dog: "The dog is on the mat.",
      day: "Today is a game day.",
      door: "The door is open.",
      duck: "The duck is in the pond.",
      desk: "The doll is on the desk.",
      doll: "The doll is on the desk.",
      drink: "Dan drinks water.",
      down: "The dog runs down the hill.",
      dinner: "Dad makes dinner.",
      dark: "The dog is dark.",
      dish: "The dish is red.",
      dream: "Dan has a dream.",
      dan: "Dan has a dream.",
      go: "We go home.",
      good: "The dog is good.",
      girl: "The girl plays a game.",
      green: "The leaf is green.",
      gate: "I go to the gate.",
      gift: "Grace has a green gift.",
      glass: "The glass is on the table.",
      goat: "The goat is in the garden.",
      garden: "The goat is in the garden.",
      gold: "Gold is in the box.",
      gray: "The gray bag is big.",
      grape: "The grape is good.",
      gum: "The gum is pink.",
      grace: "Grace has a green gift.",
      leg: "My leg is long.",
      key: "Kim has a key.",
      kid: "The kid has a kite.",
      kite: "The kite is in the sky.",
      kind: "The teacher is kind.",
      kiss: "Kim kisses Mom.",
      kitchen: "Kim is in the kitchen.",
      keep: "I keep the key.",
      king: "The king is kind.",
      kick: "The kid can kick.",
      kim: "Kim has a key.",
      kit: "The kit is on the desk.",
      kara: "Kara sees a koala.",
      kettle: "The kettle is hot.",
      keyboard: "The keyboard is black.",
      no: "No one is at home.",
      on: "The dog is on the box.",
      now: "We go now.",
      new: "The new dog is nice.",
      nine: "Nine bikes are in a line.",
      nose: "My nose is cold.",
      night: "The night is nice.",
      near: "Nina is near me.",
      nice: "The night is nice.",
      not: "I am not nine.",
      nest: "Nine nuts are in the nest.",
      nut: "The nut is in the nest.",
      need: "I need a new pen.",
      nina: "Nina has a new name.",
      north: "Now we go north.",
      pen: "The pen is on the table.",
      pig: "The pig is pink.",
      park: "We play in the park.",
      pan: "The pan is hot.",
      pot: "The pot is on the table.",
      pink: "The pig is pink.",
      play: "We play in the park.",
      please: "Please open the book.",
      paper: "The paper is white.",
      pizza: "I eat pizza.",
      piano: "I play piano.",
      party: "The party is fun.",
      cup: "The cup is on the table.",
      happy: "The child is happy.",
      open: "The old door is open.",
      top: "The top is red.",
      ten: "I have ten toys.",
      toy: "The toy is on the table.",
      tea: "Tom drinks tea.",
      two: "Two trees are tall.",
      tree: "The tree is green.",
      tall: "Two trees are tall.",
      take: "Take the book.",
      talk: "We talk at lunch.",
      time: "It is time to ride.",
      tom: "Tom drinks tea.",
      tiger: "The tiger is in the book.",
      teacher: "The teacher is kind.",
      water: "I drink water.",
      little: "The little dog runs.",
      van: "The van is blue.",
      vet: "The vet helps a dog.",
      very: "It is very cold.",
      vest: "The vest is red.",
      visit: "We visit Grandma.",
      voice: "My voice is quiet.",
      vase: "The vase is on the table.",
      video: "I watch a video.",
      violin: "The violin is in the room.",
      vera: "Vera has five books.",
      seven: "I have seven books.",
      over: "The bird flies over the tree.",
      have: "I have a book.",
      give: "I give Mom a card.",
      love: "I love my family.",
      river: "The river is blue.",
      never: "I never run inside.",
      lamp: "The lamp is on.",
      lake: "The lake is blue.",
      lion: "The lion is in the book.",
      look: "Look at the ball.",
      lunch: "We eat lunch.",
      much: "I have much to do.",
      brush: "I brush my teeth.",
      drum: "The drum is loud.",
      lily: "Lily reads a book.",
      car: "The car is red.",
      run: "I run to the room.",
      rain: "The rain is cold.",
      aim: "I aim at the goal.",
      aid: "I give aid.",
      wait: "I wait for the train.",
      paint: "I paint a small house.",
      mail: "The mail is on the table.",
      tail: "The dog has a tail.",
      sail: "The boat can sail.",
      nail: "The nail is small.",
      pain: "My hand has pain.",
      snail: "The snail is slow.",
      read: "I read a story.",
      ride: "I ride my bike.",
      ...
      sigh: "I sigh and sit down.",
      fight: "The fight is in the story.",
      sight: "My sight is good.",
      tight: "The lid is tight.",
      might: "I might go home.",
      oil: "Oil is in the pan.",
      coin: "The coin is on the table.",
      point: "I point to the book.",
      join: "We join the game.",
      boil: "The water can boil.",
      soil: "The soil is wet.",
      choice: "This choice is good.",
      noise: "The noise is loud.",
      toilet: "The toilet is clean.",
      joy: "The game brings joy.",
      royal: "The royal hat is blue.",
      loyal: "The dog is loyal.",
      roy: "Roy has a toy.",
      out: "We go out.",
      our: "Our house is small.",
      ouch: "Ouch, my foot hurts.",
      mouth: "My mouth is open.",
      loud: "The loud sound is outside.",
      sound: "The sound is loud.",
      round: "The ball is round.",
      ground: "The bag is on the ground.",
      count: "I count to ten.",
      owl: "The owl is in the tree.",
      how: "How are you?",
      town: "The town is small.",
      brown: "The cow is brown.",
      flower: "The flower is yellow.",
      towel: "The towel is wet.",
      power: "The power is off.",
      crowd: "The crowd is loud.",
      clown: "The clown is funny.",
      air: "The air is cold.",
      hair: "Her hair is long.",
      pair: "I have a pair of socks.",
      stairs: "The stairs are high.",
      fair: "The game is fair.",
      bear: "The bear is in the book.",
      pear: "The pear is on the table.",
      wear: "I wear a coat.",
      ear: "My ear is cold.",
      hear: "I hear music.",
      dear: "Dear Mom, I am happy.",
      clear: "The water is clear.",
      fear: "I have no fear.",
      tear: "A tear is on her face.",
      cheer: "We cheer for the team.",
      deer: "The deer is in the book.",
      peer: "I read with a peer.",
      care: "I care for my dog.",
      scare: "The story can scare me.",
      bare: "The table is bare.",
      rare: "The rare bird is blue.",
      dare: "I dare to try.",
      prepare: "We prepare lunch.",
      rose: "Rose has a car.",
      hot: "The food is hot.",
      hand: "My hand is clean.",
      head: "My head is cold.",
      hill: "The hill is green.",
      hello: "We say hello.",
      hungry: "I am hungry.",
      behind: "The ball is behind the chair.",
      ahead: "The road is ahead.",
      we: "We read together.",
      ...
      wet: "The dog is wet.",
      win: "I win the game.",
      wish: "I wish for a book.",
      wood: "The wood is brown.",
      woman: "The woman is kind.",
      work: "I work at school.",
      word: "I read the word.",
      white: "The wall is white.",
      away: "The dog runs away.",
      always: "We always read.",
      you: "You have a book.",
      yellow: "The sun is yellow.",
      yard: "The dog is in the yard.",
      young: "The boy is young.",
      yogurt: "I eat yogurt.",
      yesterday: "Yesterday was fun.",
      year: "The year is new.",
      your: "Your bag is blue.",
      say: "I say hello.",
      way: "This is the way home.",
      may: "May is a warm month.",
      stay: "We stay at home.",
      today: "Today is a sunny day.",
      tray: "The tray is on the table.",
      pay: "I pay for the cake.",
      clay: "The clay is soft.",
      yet: "I am not ready yet.",
      yara: "Yara has a yellow bag.",
      "yo-yo": "The yo-yo is yellow.",
      yummy: "The yogurt is yummy.",
      she: "She sees a ship.",
      ship: "The ship is big.",
      shop: "The shop is open.",
      shoe: "The shoe is in the shop.",
      shy: "The child is shy.",
      shell: "She has a short shell.",
      shirt: "I wash my shirt.",
      short: "She has a short shell.",
      shut: "The shop is shut.",
      shape: "Her shirt has a shape.",
      share: "We share a toy.",
      wash: "I wash my shirt.",
      chair: "The chair is blue.",
      chip: "I eat a chip.",
      child: "The child is happy.",
      cheese: "I like cheese.",
      chicken: "The chicken is hot.",
      chocolate: "I eat chocolate.",
      chalk: "The chalk is white.",
      chase: "The dog can chase a ball.",
      choose: "I choose a book.",
      watch: "I watch a video.",
      beach: "The beach is warm.",
      the: "The book is here.",
      this: "This is the thing.",
      that: "That book is thin.",
      then: "Then we read.",
      they: "They see three cats.",
      them: "I sit with them.",
      there: "The mother is there.",
      three: "I have three books.",
      thin: "This book is thin.",
      thank: "Thank you for this.",
      thing: "This is the thing.",
      mother: "The mother is there.",
      father: "The father sits there.",
      brother: "My brother reads a book.",
      with: "I play with my family.",
      what: "What is this?",
      when: "When do we read?",
      where: "Where is my book?",
      why: "Why is the dog wet?",
      which: "Which book is yours?",
      wheel: "The wheel is big.",
      whale: "The whale is in the book.",
      while: "I read while Mom cooks.",
      whisper: "I whisper to my friend.",
      who: "Who is at the door?",
      her: "Her bird sings.",
      first: "The girl reads first.",
      skirt: "The skirt is red.",
      turn: "It is your turn.",
      nurse: "The nurse helps us.",
      purple: "The shirt is purple.",
      or: "Do you want water or milk?",
      fork: "I have a fork.",
      sport: "We play a sport.",
      are: "We are at the park.",
      arm: "My arm is strong.",
      art: "I like art.",
      star: "The star is bright.",
      card: "I make a card.",
      smart: "The child is smart.",
      he: "He reads with me.",
      i: "I ride my bike.",
      eel: "The eel is in the water.",
      seed: "The seed is small.",
      bee: "The bee is on the flower.",
      free: "I am free today.",
      week: "This week is fun.",
      idea: "I have an idea.",
      island: "The island is in the book.",
      line: "The white line is long.",
      smile: "The child has a nice smile.",
      find: "I find my bike.",
      old: "The old coat is blue.",
      only: "Only Tom has a phone.",
      phone: "Tom has a phone.",
      stone: "The stone is by the boat.",
      boat: "The boat is on the water.",
      snow: "Snow is on the window.",
      slow: "The car is slow.",
      show: "We show the book.",
      own: "I have my own book.",
      grow: "The plant can grow.",
      bowl: "The bowl is on the table.",
      pillow: "The pillow is soft.",
      shadow: "The shadow is long.",
      throw: "I throw the ball.",
      low: "The table is low.",
      use: "I use a computer.",
      unit: "The unit is small.",
      uniform: "The uniform is blue.",
      usually: "I usually hear music.",
      cute: "The cute cat sleeps.",
      student: "The student reads in June.",
      june: "June is warm.",
      cube: "The cube is blue.",
      huge: "The room is huge.",
      tube: "The tube is on the table.",
      computer: "I use a computer.",
      menu: "The menu is simple.",
      pupil: "The pupil reads.",
      jump: "Jack can jump.",
      jam: "I like jam.",
      jacket: "The jacket is blue.",
      july: "July is warm.",
      joke: "The joke is funny.",
      jeans: "The jeans are blue.",
      juice: "I drink juice.",
      jungle: "The jungle is green.",
      jack: "Jack reads a book.",
      zoo: "The zoo is big.",
      zebra: "The zebra is in the book.",
      zero: "The number is zero.",
      zip: "The zip is open.",
      zipper: "The zipper is stuck.",
      zoom: "The car can zoom.",
      zack: "Zack reads a book.",
      lizard: "The lizard is small.",
      puzzle: "The puzzle is fun.",
      busy: "I am busy.",
      lazy: "The dog is lazy.",
      crazy: "The game is crazy.",
      cake: "I eat cake.",
      cow: "The cow is brown.",
      coat: "The coat is blue.",
      corn: "I eat corn.",
      oak: "The oak is tall.",
      oat: "The oat is small.",
      soap: "The soap is by the sink.",
      toast: "I eat toast.",
      goal: "The goal is easy.",
      float: "The boat can float.",
      coach: "The coach is kind.",
      loaf: "The loaf is on the table.",
      cold: "The water is cold.",
      class: "The class is quiet.",
      clean: "The room is clean.",
      cloud: "The cloud is white.",
      candy: "The candy is sweet.",
      can: "I can read.",
      picnic: "The picnic is fun.",
      city: "The city is big.",
      circle: "The circle is red.",
      center: "The center is here.",
      cereal: "I eat cereal.",
      ice: "The ice is cold.",
      bicycle: "The bicycle is red.",
      queen: "The queen is kind.",
      quick: "The rabbit is quick.",
      quiet: "The room is quiet.",
      quilt: "The quilt is warm.",
      question: "I ask a question.",
      quiz: "The quiz is easy.",
      quite: "It is quite cold.",
      quarter: "I have a quarter.",
      square: "The square is red.",
      squirrel: "The squirrel is in the tree.",
      up: "I jump up.",
      us: "Come with us.",
      under: "The cup is under the table.",
      uncle: "My uncle is kind.",
      cut: "I cut the fruit.",
      mud: "The mud is wet.",
      back: "I go back home.",
      neck: "My neck is cold.",
      clock: "The clock is on the wall.",
      black: "The cat is black.",
      truck: "The truck is big.",
      snack: "I eat a snack.",
      stick: "The stick is long.",
      rock: "The rock is small.",
      lock: "I lock the door.",
      pick: "I pick a book.",
    };
    return englishSpecificPhrases[normalized] || `I read the word "${word}".`;
  }
  if (languageName === "Brazilian Portuguese") {
    const portugueseSpecificPhrases: Record<string, string> = {
      ...
      irmã: "Minha irmã lê um livro.",
      criança: "A criança canta.",
      canta: "Ana canta na sala.",
      anda: "O menino anda devagar.",
      planta: "A planta está na sala.",
      tem: "Ela tem um livro.",
      bem: "Tudo está bem.",
      sem: "Eu fico sem medo.",
      sente: "O menino sente frio.",
      entrada: "A entrada fica perto.",
      sim: "Sim, eu vou.",
      fim: "O fim da aula chegou.",
      mim: "Isto é para mim.",
      cinco: "Eu tenho cinco lápis.",
      tinta: "A tinta é azul.",
      pintar: "Eu gosto de pintar.",
      cinto: "O cinto é preto.",
      bom: "O dia está bom.",
      som: "O som está baixo.",
      com: "Eu vou com Ana.",
      onde: "Onde está o livro?",
      ontem: "Ontem eu li um texto.",
      conta: "A conta está certa.",
      contar: "Eu vou contar uma história.",
      ponto: "O ponto está no mapa.",
      sombra: "A sombra é grande.",
      compra: "A compra está na mesa.",
      fundo: "O fundo é azul.",
      segundo: "O segundo livro é meu.",
      nenhum: "Nenhum aluno saiu.",
      algum: "Eu tenho algum tempo.",
      comum: "Isso é comum.",
      assunto: "O assunto é simples.",
      ...
      ela: "Ela lê um livro.",
      perto: "A escola fica perto.",
      mel: "O mel está na mesa.",
      céu: "O céu está azul.",
      josé: "José está na escola.",
      quer: "Ela quer brincar.",
      bela: "A flor é bela.",
      medo: "Eu tenho medo.",
      ...
      este: "Este livro é bom.",
      avó: "Minha avó está em casa.",
      avô: "Meu avô está em casa.",
      ovo: "O ovo está no prato.",
      rosto: "Meu rosto está limpo.",
      todo: "Todo aluno lê.",
      gordo: "O gato é gordo.",
      coroa: "A coroa está no livro.",
      voa: "A ave voa alto.",
      hora: "A hora do lanche chegou.",
      agora: "Agora eu vou brincar.",
      fora: "Eu vou para fora.",
      nova: "A mochila é nova.",
      posso: "Eu posso ler agora.",
      olha: "Ela olha a porta.",
      porco: "O porco está no livro.",
      história: "A história é bonita.",
      próximo: "O parque fica próximo.",
      ótimo: "O dia está ótimo.",
      volta: "A volta para casa é calma.",
      ...
      pato: "O pato está no lago.",
      pai: "Meu pai está em casa.",
      pé: "Meu pé está limpo.",
      papel: "O papel é branco.",
      pacote: "O pacote está na mesa.",
      copo: "O copo está na mesa.",
      mapa: "O mapa está na parede.",
      tempo: "Eu tenho tempo.",
      limpo: "O chão está limpo.",
      campo: "O campo é verde.",
      capa: "A capa do livro é bonita.",
      tatu: "O tatu está no livro.",
      teto: "O teto é branco.",
      tudo: "Tudo está pronto.",
      todos: "Todos estão na sala.",
      trem: "O trem chega cedo.",
      tarde: "A tarde está calma.",
      tomar: "Eu vou tomar água.",
      tocar: "Eu vou tocar música.",
      turma: "A turma está na sala.",
      carta: "A carta está na mesa.",
      estudante: "O estudante lê um livro.",
      vaca: "A vaca está no campo.",
      vaso: "O vaso está na mesa.",
      vida: "A vida é boa.",
      vento: "O vento está forte.",
      vestido: "O vestido é bonito.",
      voltar: "Eu vou voltar cedo.",
      você: "Você está aqui.",
      vai: "Ela vai para casa.",
      vejo: "Eu vejo uma uva.",
      vivo: "Eu vivo aqui.",
      uva: "A uva está na mesa.",
      cavalo: "O cavalo está no campo.",
      palavra: "A palavra está no livro.",
      favor: "Por favor, sente aqui.",
      zero: "O número é zero.",
      zebra: "A zebra está no livro.",
      zíper: "O zíper está aberto.",
      zeca: "Zeca está na escola.",
      zangado: "O menino está zangado.",
      zoológico: "O zoológico fica longe.",
      casa: "A casa é bonita.",
      camisa: "A camisa é azul.",
      doze: "Eu tenho doze lápis.",
      onze: "Eu tenho onze livros.",
      tesoura: "A tesoura está na mesa.",
      caderno: "O caderno está na mochila.",
      carne: "A carne está no prato.",
      cor: "A cor é bonita.",
      corpo: "Meu corpo está forte.",
      curto: "O caminho é curto.",
      macaco: "O macaco está na árvore.",
      sacola: "A sacola está na cadeira.",
      pouco: "Eu como pouco.",
      rico: "O texto é rico em palavras.",
